export default function HowItWorks() {
  const steps = [
    {
      num: "01",
      title: "Загрузи резюме и вакансию",
      desc: "Добавь файл, текст или ссылку — сервис сам всё распознает и подготовит к анализу.",
      tag: "30 секунд",
    },
    {
      num: "02",
      title: "Ответь на пару вопросов",
      desc: "ИИ уточнит детали твоего опыта и поможет усилить резюме за счёт реальных кейсов.",
      tag: "Match растёт на 10–15%",
    },
    {
      num: "03",
      title: "Получи готовый отклик",
      desc: "Скачай обновлённое резюме, получи сопроводительное и сохрани вакансию в трекер.",
      tag: "Трекер + история откликов",
    },
  ];
